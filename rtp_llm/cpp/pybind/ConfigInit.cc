...
PYBIND11_MODULE(libth_transformer_config, m) {
    ...
    py::class_<SpeculativeExecutionConfig>(m, "SpeculativeExecutionConfig")
        ...
        .def_readwrite("eagle3_aux_hidden_state_layer_ids",
                       &SpeculativeExecutionConfig::eagle3_aux_hidden_state_layer_ids)
        ...
        .def(py::pickle(
            [](const SpeculativeExecutionConfig& self) {
                return py::make_tuple(self.model_type,
                                      ...
                                      self.eagle3_aux_hidden_state_layer_ids);
            },
            [](py::tuple t) {
                if (t.size() != 11)
                    throw std::runtime_error("Invalid state!");
                ...
                try {
                    ...
                    c.eagle3_aux_hidden_state_layer_ids = t[10].cast<std::vector<int>>();
                } catch (const std::exception& e) {
