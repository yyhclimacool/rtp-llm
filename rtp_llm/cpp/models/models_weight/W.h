...
// Draft-to-target / target-to-draft token ID lookup tables for reduced-vocab Eagle3 models.
// d2t[draft_token] -> target_token   shape: [draft_vocab_size]  dtype: int32
// t2d[target_token] -> draft_token   shape: [target_vocab_size] dtype: int32  (-1 = not in draft vocab)
static const std::string eagle3_d2t = "eagle3.d2t";
static const std::string eagle3_t2d = "eagle3.t2d";
...
static const std::string attn_qkv_s2  = "self_attention_weights.query_weight.weight_scale_2";
static const std::string attn_qkv_i_s = "self_attention_weights.query_weight.input_scale";
...
static const std::string attn_o_s2    = "self_attention_weights.attention_output_weight.weight_scale_2";
static const std::string attn_o_i_s   = "self_attention_weights.attention_output_weight.input_scale";
...
static const std::string ffn_w1_s2    = "ffn_weights.intermediate_weight.weight_scale_2";
static const std::string ffn_w1_i_s   = "ffn_weights.intermediate_weight.input_scale";
...
static const std::string ffn_w3_s2    = "ffn_weights.intermediate_weight3.weight_scale_2";
static const std::string ffn_w3_i_s   = "ffn_weights.intermediate_weight3.input_scale";
...
static const std::string ffn_w13_s2   = "ffn_weights.intermediate_weight13.weight_scale_2";
static const std::string ffn_w13_i_s  = "ffn_weights.intermediate_weight13.input_scale";
...
static const std::string ffn_w2_s2    = "ffn_weights.intermediate_weight2.weight_scale_2";
static const std::string ffn_w2_i_s   = "ffn_weights.intermediate_weight2.input_scale";
...
static const std::string moe_w1_s2    = "partial_moe_weights.intermediate_weight.weight_scale_2";
static const std::string moe_w1_i_s   = "partial_moe_weights.intermediate_weight.input_scale";
...
static const std::string moe_w2_s2    = "partial_moe_weights.intermediate_weight2.weight_scale_2";
static const std::string moe_w2_i_s   = "partial_moe_weights.intermediate_weight2.input_scale";
